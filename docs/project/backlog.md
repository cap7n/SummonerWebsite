...
- <span class="pill done">DONE</span> **First-playtest wave 2** (2026-08-01): info card (hover → white base stats + mod contributions in mod colours), enemy mod drops (host pity-roll, ground props, walk-over pickup), 13-active hard cap + Disenchant table (grave-less items grind into permanent pool points), standby row + cold hot-swap, sell/undo everywhere, pause menu on Esc, mana, colour pads (incl. red, at your own risk); combat feel: pack aggro capped 55 u, crowd-wide alert 16 u, chase-leash hysteresis 85%→125%
